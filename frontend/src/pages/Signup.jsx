...
import { Mail, Lock, User, Code2, AlertCircle } from 'lucide-react';
...
const Signup = () => {
    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-96 h-96 rounded-full bg-primary-300/30 blur-3xl"></div>
            <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 rounded-full bg-indigo-300/30 blur-3xl"></div>
